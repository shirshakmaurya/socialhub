...
import { BsFillPatchPlusFill,BsFillBookmarkFill } from 'react-icons/bs'
                ...
                <div className="nav-upper-section">
                    <div className="nav-head" onClick={() => navHeadClickHandler()}>
                        ...
                        <div className="nav-img-container">
                            <img src={require('../../resources/images/wizard_hat.png')} alt="" className="nav-img" />
                        </div>
                    ...
                    <div className="nav-links">
                        ...
                        <NavLink to={'/bookmarks'} className={'nav-link'} onClick={() => setIsMobileViewOpen(false)}>
                            <BsFillBookmarkFill className='nav-img' /> <span className="nav-text">Bookmarks</span>
                        </NavLink>
                    </div>
                    <div className="btn-container">
                        <button className="post-btn" onClick={() => postBtnClickHandler()}><BsFillPatchPlusFill className='btn-img' />
